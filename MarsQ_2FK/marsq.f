...
C.....ERROR FIELD AMPLIFICATION
      ...
      ENDIF   
C
C.....THE FEEDBACK ASSEMBLY ABOVE WANTS THE VACUUM T=1 THAT FEEDCTRL
C.....INSTALLED.  IT IS FINISHED NOW, SO WITH KEEPTFUN=1 PUT THE
C.....EQUILIBRIUM F(S) BACK BEFORE KJP AND THE KINETIC MODULE.
      IF (KTREST.NE.0) THEN
         DO J=1,NRP1
            T(J)  = TSAVE(J)
         ENDDO
...
C     RESET EVERY TIME
      ...
      IF (KPITCHOUT.LT.0.OR.KPITCHOUT.GT.1) GOTO 330
      IF (KPITCHOUT.EQ.1.AND.INCKIN.LE.0) GOTO 340
...
C     DERIVED QUANTITIES
 ...
 320  WRITE(*,*) ' ERROR AT MARS-K NTV INPUT'
      ...
      IGO = -1
      RETURN
 330  WRITE(*,*) ' ERROR AT PITCH-FREQUENCY DIAGNOSTIC INPUT'
      WRITE(*,*) ' KPITCHOUT MUST BE 0 OR 1'
      IGO = -1
      RETURN
 340  WRITE(*,*) ' ERROR AT PITCH-FREQUENCY DIAGNOSTIC INPUT'
      WRITE(*,*) ' KPITCHOUT=1 REQUIRES INCKIN>0'
      IGO = -1
      RETURN

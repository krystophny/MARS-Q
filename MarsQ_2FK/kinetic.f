...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC  
      IF (ISMPIRUN.EQ.1.OR.ISMPIRUN.EQ.3) THEN
        ...
        TAG(3)=3
        TAG(4)=4
C       Slots 19 and 20 carry VX3PARA/VX3PERP, so the transmitted count
C       must cover them; BUFFER_DATA is allocated with 30.
        BUFFERSIZE = MSMAX*MSMAX*20
...
C     FILL IN MATRICES FOR KXDPHI FOR NEUTRALITY EQUATION
 ...
 1    CONTINUE
     ...
     &            RJB,RX1P,RX1B,RX1R,RX2,RX3,RQ1,RQ2,
     &            RBT,RPHI,RDMU,RDB )
      DEALLOCATE( RCHIK,RPHIK,RTK,
     &            RHK,RJBK,RX1PK,RX1BK,RX1RK,RX2K,RX3K,
     &            RQ1K,RQ2K,RVALK )
      DEALLOCATE( RVAK1,RVAK2,RVAK3,RVAK4,RVAK5,RVAK6,RVAK7,RVAK8 )
      DEALLOCATE( RCHIN,RVALN,RHN )
      DEALLOCATE( VPARA,VPERP,VDPHI,VX1,VX2,VX3,VQ1,VQ2,VQ3,VDP )
...
C         TRANSIT COMPONENT
 ...
 121  FORMAT(I2,1X,5(E13.5))
      ...
      DEALLOCATE (X1PARA,X2PARA,X3PARA,X3PERP,
     &            Q1PARA,Q2PARA,Q3PARA,DPPARA,
     &            X1PERP,X2PERP,Q1PERP,Q2PERP,Q3PERP,DPPERP,
     &            X1DPHI,X2DPHI,Q1DPHI,Q2DPHI,Q3DPHI,DPDPHI)
      RETURN

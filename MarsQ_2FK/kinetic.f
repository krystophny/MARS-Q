...
C     RUNNING MAXIMUM OVER ALL SURFACES. PROBING ONLY IS=NR/2 GAVE A FALSE
C     POSITIVE FOR DELRATS>0, WHERE THE RATIONAL-SURFACE EXCLUSION BAND CAN
C     LEGITIMATELY ZERO THE CACHE ON THAT ONE SURFACE WHILE THE PRESSURES
C     STAY HEALTHY. A GENUINE FAILURE ZEROES EVERY SURFACE, SO THE GLOBAL
C     MAXIMUM STILL CATCHES IT.

...
C     FLUID RESPONSE.  THE NTV ENERGY CONTRACTION STILL REQUIRES THE
...
C     COME FROM THE VALIDATED PCOEF CACHE.  WHEN THE FIELD WAS IMPORTED, THE
C     CALLER RESTORES THE VALIDATED B/X ARRAYS AFTER THIS ROUTINE RETURNS.
      AL0SAVE = AL0
      AL0 = ALNORM
      KJPKEY = 0
      KPBKEY = 1

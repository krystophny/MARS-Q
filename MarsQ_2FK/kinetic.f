...
C     COMPUTATION OF PPERP AND PPARA  
     ...
     $                       ESUBM,FSUBM,GSUBM,HSUBM)
      ...
      REAL*8 PI2,CACHEMAX,FIELDMAX,OPMAX,PPARAMAX,PPERPMAX
     ...
     &          BUFFER_DATAM(MSMAX,MSMAX,TOTINDX,30))
      ...
      BUFFERT => BUFFER_I1
      CALL READ_SURFACE_QUANTITIES (1,1)
      DO IS=1,NRP1-1
...
C     CALCULATE ENERGY PROFILE OF DIFFERENT COMPONENTS
     ...
     &         ABS(ESUBM(LXROW+KXV1,LYCOL+KYPPARA,IS+1)))
      ...
      WRITE(*,*) 'DWK CACHE/FIELD/OPERATOR/PARA/PERP MAXIMA:',
     &           CACHEMAX,FIELDMAX,OPMAX,PPARAMAX,PPERPMAX
      IF (CACHEMAX.LE.0.0.OR.FIELDMAX.LE.0.0.OR.OPMAX.LE.0.0.OR.

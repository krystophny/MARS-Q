...
C=======================================================================
     ...
     & JS,KGRID
C     ALL OPTIONAL TRACE WRITERS SHARE ASSIGNFREEFILEUNIT.  USE THE SAME
C     LOCK AS KG, KH, PITCH, ACTION-ENERGY, AND KJPMAT WRITERS SO ANOTHER
C     THREAD CANNOT REBIND FID WHILE THIS COMPLETE CALL IS SERIALIZED.

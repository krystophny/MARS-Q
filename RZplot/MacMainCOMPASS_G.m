...
Mac.resetCoil = 1;
%Mac.coilN  = [0.5671  0.4060  0.7433  0.2500; 0.7433  0.2500 0.7433 -0.2500; 0.7433 -0.2500  0.5671 -0.4060];     
%Mac.coilN  = [0.5671  0.4060  0.7433  0.2500; 0.7433 -0.2500  0.5671 -0.4060];     
Mac.coilN  = [0.7433  0.2500 0.7433 -0.2500];     
             % COMPASS RMP coils
%Mac.rw     = [0.9294];
...
SDIR = '/cscratch/liuy/WorkRE_COMPASS/';

...
%Mac.coilN  = [2.9319    1.6550    2.9311   -2.0300];     
             % MAST/MAST-U EFCC
%Mac.coilN  = [1.311 -0.791 1.426 -0.591];     
             % MAST LOWER SET OF ELM coils: [R1 Z1 R2 Z2]
Mac.coilN  = [1.418 0.760 1.488 0.499; 1.418 -0.760 1.488 -0.499];     
             % MAST-U ELM coils: [R1 Z1 R2 Z2;...]
%Mac.coilN  = [1.418 -0.760 1.488 -0.499];     
             % MAST-U LOWER SET OF ELM coils: [R1 Z1 R2 Z2]
%Mac.coilN  = [1.418 0.760 1.488 0.499];     
             % MAST-U UPPER ELM coils: [R1 Z1 R2 Z2;...]
...
%SDIR = '/home/liuy/Work/MAST/DataA/';
%SDIR = '/home/liuy/Work/RWM/Data/27112/';
%SDIR = '/cscratch/liuy/WorkMASTb/';
%SDIR = '/cscratch/liuy/WorkEFC/Database/DataSave/';

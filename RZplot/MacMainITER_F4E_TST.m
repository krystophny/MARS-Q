...
% RZ coordinates
[RM,ZM] = MacReadRMZM([SDIR2 'RMZM_F.OUT']);
[R,Z] = MacGetRZ(RM,ZM);
...
if Mac.RunEF==1
   MacGetB1EF([SDIR 'surfs_ef.dat'],R,Z,dRdchi,dZdchi);
elseif Mac.RunEF==2
   %MacGetB1EF([SDIR 'surft_ef_2007554.dat'],R,Z,dRdchi,dZdchi);
   MacGetB1EF([SDIR2 'surft_ef.dat'],R,Z,dRdchi,dZdchi);
   %MacGetB1EF([SDIR2 'surft_ef.dat'],R,Z,dRdchi,dZdchi);
end
...
%[BM1,BM2,BM3] = MacReadBPLASMA([SDIR2 'BPLASMA_VAC']);
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR2 'BPLASMA.OUT']);
...
% perturbed velocity
if Mac.RunV
[VM1,VM2,VM3,DPSIDS,T] = MacReadVPLASMA([SDIR2 'XPLASMA.OUT']);

function [A1,A2a,A2b,A3] = MacBcGetCtMat(R,Z,dRds,dZds,dRdchi,dZdchi,jacobian)
...
Rw = R(II,:)*Mac.R0EXP;
Zw = Z(II,:)*Mac.R0EXP;
Jw = jacobian(II,:)*Mac.R0EXP.^3;
G12w = (dRds(II,:).*dRdchi(II,:) + dZds(II,:).*dZdchi(II,:))*Mac.R0EXP.^2;

...
Mac.DivJ  = 0;
Mac.plot_DivJ = 0;
Mac.plot_JM_EQ = 0; %valid if Mac.RunEQ>0
Mac.plot_JM_KD = 1;
Mac.NRES       = 10;  %=10
Mac.case = 'n3_L';
...
%SDIR = '/home/liuy/Work/D3D157376/Data/';
...
SDIR = '/cscratch/liuy/WorkWESSON_02/';
...
%Mac.JNORM = Mac.B0EXP/Mac.R0EXP/(4.0e-7*pi)/1e+6;
...
if Mac.RunJ
[JM1,JM2,JM3,JMRE] = MacReadJPLASMA([SDIR 'JPLASMA.OUT'],R,Z,jacobian);
...
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_n6']);
...
% perturbed velocity
if Mac.RunV
[VM1,VM2,VM3] = MacReadVPLASMA([SDIR 'VPLASMA.OUT']);

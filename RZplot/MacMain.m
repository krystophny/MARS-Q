...
Mac.coil   = [1.24 0.1334 0.2584; 1.24 -0.2530 -0.123];     % coils position defined as [rc chi_1 chi_2]
Mac.resetCoil = 0;
%Mac.coilN  = [3.23 0 1.6];     % C-coil: [Rc Zc W]
Mac.coilN  = [2.184 1.012 2.394 0.504; 2.184 -1.012 2.394 -0.504];     % I-coil: [R1 Z1 R2 Z2;...]
Mac.rw     = [0.9966];
...
% RZ coordinates
%[RM,ZM] = MacReadRMZM('../SHOTCariddiCirc/RMZM_F');
%[RM,ZM] = MacReadRMZM('../SHOTAnalCirc/RMZM_F_RFA');
%[RM,ZM] = MacReadRMZM('../SHOT117327/RMZM_F_RFA');
[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_RFA']);
[R,Z] = MacGetRZ(RM,ZM);
...
Mac.ZNORM  = FEEDI(KFEED,2)/fac/I0EXP;
...
if Mac.RunJ
%[JM1,JM2,JM3] = MacReadJPLASMA('../SHOTAnalCirc/JPLASMA_WALL');
...
%[BM1,BM2,BM3] = MacReadBPLASMA(['../SHOTAnalCirc/BPLASMA_ICOIL' int2str(FEEDI(KFEED,1))]);
%[BM1,BM2,BM3] = MacReadBPLASMA('../SHOTAnalCirc/BPLASMA_RFA_VAC2');
%[BM1,BM2,BM3] = MacReadBPLASMA(['../SHOT117327/BPLASMA_ICOIL' int2str(FEEDI(KFEED,1))]);
%[BM1,BM2,BM3] = MacReadBPLASMA(['../SHOT117327/BPLASMA_RFA_VAC']);
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_' int2str(FEEDI(KFEED,1))]);

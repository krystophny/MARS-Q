...
Mac.SS = 'b-';
Mac.plot_RZ = 0;
Mac.plot_shape = 0; %plot wall shape
...
Mac.Nchi   = 937;    % number of points along poloidal angle 'chi'
...
%Mac.rw     = [1.0 1.381 1.396 1.411 1.727 1.742 1.757 2.967];
%Mac.rw     = [1.0 1.396 1.742];
%Mac.rw     = [1.205 1.384];
Mac.rw     = [1.3];
...
if Mac.RunB
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_WALL']);

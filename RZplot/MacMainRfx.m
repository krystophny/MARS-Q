...
Mac.plot_BWC = 0;    %2D plot real-space Bwn along physical theta anf phi
...
SDIR = '/.automount/funsrv1/root/home/yliu/Rfx/BPLASMA_Srwm/';
%SDIR = '/.automount/funsrv1/root/home/yliu/Rfx/ResEQ4b/';
...
if Mac.RunEQ
[QEQ] = MacReadPROFEQ([SDIR 'PROFEQ']);
end

% normalization for B-field
I0EXP = 1.0e+3;      %[A] vacuum shot
mu0   = 4e-7*pi;
fac   = mu0/Mac.B0EXP/Mac.R0EXP;
FEEDI = 1.0;
%Mac.BNORM  = FEEDI/fac/I0EXP;
...
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_RWM']);

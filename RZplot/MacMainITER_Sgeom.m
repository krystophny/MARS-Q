...
Mac.SS = 'b-';
Mac.plot_RZ = 0;
Mac.plot_shape = 1; %plot wall shape
Mac.plot_thickness = 0; %plot wall thickness
Mac.plot_RZM= 0;
...
Mac.coil   = [2.0195 1.1634e-1 -1.2332e-1; 1.2052 -0.0065 -0.0065];     % coils position defined as [rc chi_1 chi_2]
Mac.resetCoil = 1;
%Mac.coilN  = [7.75345 3.42 8.27958 2.67661; 8.67751 1.80193 8.71926 -0.56554; 8.27548 -1.57589 7.57743 -2.59528]; %ITER ELM coils option 1
%Mac.coilN = [7.7349 3.3802 8.2624 2.6262; 8.6180 1.7904 8.6610 -0.5498; 8.2301 -1.5460 7.7712 -2.3815; 7.8 2.9 7.8 2.9; 8.4 0.5 8.4 0.5; 7.8 -1.8 7.8 -1.8];
Mac.coilN = [11.2742 3.9 11.2742 -3.0];
Mac.rw     = [1.0 1.262 1.496];
Mac.rs     = 1.01; % the position of equivalent sheet current from CARIDDI
Mac.cut_RZ  = -1; %cut RZ-space beyond the value, not effective when <0 
...
%SDIR = '/.automount/funsrv1/root/home/yliu/Scen4_V15/Backward/';
%SDIR = '/.automount/funsrv1/root/home/yliu/Scen4_V12/';
SDIR = '/scratch/yliu/Iter/BPLASMA_Srwm/';
...
Mac.chi = linspace(-0.32*pi,0.32*pi,Mac.Nchi);
...
if Mac.plot_metric, MacGetMetric(R,Z,dRds,dZds,dRdchi,dZdchi,jacobian), end

% perturbed plasma current
if Mac.RunJ
[JM1,JM2,JM3] = MacReadJPLASMA([SDIR 'JPLASMA_RWM']);

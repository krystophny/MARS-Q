...
Mac.rw     = [1.0000 1.2314 1.2706 1.5089];
...
SDIR = '/home/yliu/ITER/Scen4_V16/Work/';
...
if Mac.RunEF==1
   ...
   %MacGetB1EF([SDIR '10738_surf_ef_n=2.dat'],R,Z,dRdchi,dZdchi);
    MacGetB1EF([SDIR '10738_surf_efcc_n=1.dat'],R,Z,dRdchi,dZdchi);
elseif Mac.RunEF==2
...
% perturbed velocity
if Mac.RunV
[VM1,VM2,VM3,DPSIDS,T] = MacReadVPLASMA([SDIR 'VPLASMA_ZOW.OUT']);

...
Mac.kSVD      = 1;  %perform SVD analysis if >0
Mac.kSVDeigen = 1;  %plot SVD eigenvector with the given number
Mac.kSVDsum   = 10;  %sum all SVD eigenvectors from 1 to the given number
Mac.kRAW      = 0;
Mac.kSVDreconst = 1; 
...
%SDIR = '/cscratch/liuy/WorkIR_D/CC/';
%SDIR = '/cscratch/liuy/Temp/3D/n3/';
%SDIR  = '/home/liuy/Work/IR_D/Database/D3D/157376/3D/n3/';
%SDIR = '/home/liuy/Work/IR_D/Database/ITER/131037.0003/3D/n1/';
%SDIR = '/cscratch/liuy/WorkIR_D/Exception/DIII-D/138593/3D/n4/';
%SDIR = '/cscratch/liuy/WorkIR_D/Exception/ITER/131037.0003/3D/n2/';
%SDIR = '/cscratch/liuy/WorkIR_D/Database/DIII-D/138593/3D/n4/';  %U
...
if Mac.RunJ
[JM1,JM2,JM3,JMRE] = MacReadJPLASMA([SDIR SDIR2 'JPLASMA.OUT']);
...
% perturbed velocity
if Mac.RunV
[VM1,VM2,VM3,DPSIDS,T,VM1N] = MacReadVPLASMA([SDIR SDIR2 'XPLASMA.OUT']);

...
Mac.RunEF   = 1;  %1: read error field at one surface in vacuum, for generating equivalent surface current
...
afac  = 1.0; phas=0; 
%afac  = 1.0; phas=0; 
%afac = 5.7660e-04; phas=0; %MAST-U46943_Case1
...
%SDIR = '/home/liuy/Work/STEP-P/Case1/Data/';
%SDIR = '/cscratch/liuy/STEP-P/Case1/';
%SDIR = '/home/liuy/Work/ITER_RIPPLE/Data/9MA/';
SDIR = '/home/liuy/Work/ITER_RIPPLE/Data/10MA/';
%SDIR = '/home/liuy/Work/ITER_RIPPLE/Data/5MA_GAP3/';
...
if Mac.RunEF==1
   ...
   %MacGetB1EF(['/home/liuy/Work/ITER_RIPPLE/Expt/9MA_RIPPLE/surfs_ef.dat'],R,Z,dRdchi,dZdchi);
   %MacGetB1EF(['/home/liuy/Work/ITER_RIPPLE/Expt/9MA_RIPPLE_FI_TBM/surfs_ef.dat'],R,Z,dRdchi,dZdchi);
   %MacGetB1EF([SDIR 'surfs_rip.dat'],R,Z,dRdchi,dZdchi);
   MacGetB1EF([SDIR 'surfs_cor.dat'],R,Z,dRdchi,dZdchi);
elseif Mac.RunEF==2
...
if Mac.RunJ
[JM1,JM2,JM3,JMRE] = MacReadJPLASMA([SDIR 'JPLASMA.OUT']);
...
% perturbed velocity
if Mac.RunV
[VM1,VM2,VM3,DPSIDS,T,VM1N] = MacReadVPLASMA([SDIR 'XPLASMA' SCASE]);
...
% perturbed pressure
if Mac.RunP
[PM1,PM2,PM3,PM4,PM5] = MacReadPPLASMA([SDIR 'PPLASMA' SCASE]);

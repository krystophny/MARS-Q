...
%parameters for plotting field line pitch
Mac.spitch = sqrt(0.95); %minor radius of plasma magnetic surface where to plot field line pitch
Mac.plot_pitch = 3;
...
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'REK/BPLASMA.OUT']);
...
if Mac.plot_pitch > 0
   MacPlotFieldPitch(TEQ,DPSIEQ,R,jacobian,Bn);
end
...
% perturbed velocity
if Mac.RunV
[VM1,VM2,VM3,DPSIDS,T] = MacReadVPLASMA([SDIR 'REK/XPLASMA.OUT']);

...
%Mac.coil   = [1.2883 1.6406e-1 2.6562e-1; 1.2883 -2.6953e-1 -1.6797e-1];     
Mac.coil   = [1.2545 1.6797e-1 2.6953e-1; 1.2545 -2.6562e-1 -1.6406e-1];     
           % coils position defined as [rc chi_1 chi_2]
Mac.resetCoil = 0;
Mac.coilN  = [2.394 1.012 2.394 0.504; 2.394 -0.504 2.184 -1.012];     
             % D3D I-coils: [R1 Z1 R2 Z2;...]
%Mac.coilN  = [3.23 0.80 3.23 -0.80];     
             % D3D C-coils
%Mac.coilN  = [2.4320 0.2691 2.4320 -0.3309];     
             % D3D M-coils
%Mac.coilN  = [2.184 1.012 2.394 0.504; 2.394 -0.504 2.184 -1.012; 3.23 0.80 3.23 -0.80];     
             % D3D I-coils+C-coil: [R1 Z1 R2 Z2;...]
...
%SDIR = '/home/liuy/Work/D3D174446/Data/';
%SDIR = '/cscratch/liuy/WorkTEMP/';
%SDIR = '/home/liuy/Work/D3D157376/Data_Mn6/';
...
%SDIR = '/cscratch/liuy/IR_D/Database/DIII-D/157376/3D/n1/';

...
Mac.Nchi   = 512;    % number of points along poloidal angle 'chi'
...
% RZ coordinates
[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_MAST30128_n2']);
[R,Z] = MacGetRZ(RM,ZM);
...
if Mac.RunEF==1
   ...
   %MacGetB1EF([SDIR '26128_surf_efcc_n=1.dat'],R,Z,dRdchi,dZdchi);
    MacGetB1EF([SDIR '../Expt/30128_decompose_surf_n_2.dat'],R,Z,dRdchi,dZdchi);
elseif Mac.RunEF==2

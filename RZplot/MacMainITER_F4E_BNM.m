...
SDIR = '/home/yliu/F4E_2014/DataRes/10470/n=6/';
SFLD = '15MAFTFITBMELM';
...
if Mac.RunEF==1
   MacGetB1EF([SDIR SFLD '/surfs_ef.dat'],R,Z,dRdchi,dZdchi);
elseif Mac.RunEF==2
   %MacGetB1EF([SDIR 'surft_ef_2007554.dat'],R,Z,dRdchi,dZdchi);
   %MacGetB1EF([SDIR '13836289/surfs_ef.dat'],R,Z,dRdchi,dZdchi);
   %MacGetB1EF([SDIR '9MAFTFITBM/surfs_ef.dat'],R,Z,dRdchi,dZdchi);
   %MacGetB1EF([SDIR '15MAFTFI/surfs_ef.dat'],R,Z,dRdchi,dZdchi);
   MacGetB1EF([SDIR SFLD '/surfs_ef.dat'],R,Z,dRdchi,dZdchi);
end

...
%Mac.coilN  = [3.23 0.80 3.23 -0.80];     
             % D3D C-coils
%Mac.coilN  = [1.9423 0.8490 2.0982 0.5846; 2.0102 -0.5867 1.8509 -0.8291];
             % AUG B-coils: [R1 Z1 R2 Z2;...]
%Mac.coilN  = [7712.2  3402.8 8275.9  2597.1; ...
%	      8661.6  1780.2 8665.4 -586.3; ...
%              8246.8 -1490.6 7817.5 -2437.2]/1000;
             % ITER ELM coils: [R1 Z1 R2 Z2;...]
Mac.rw     =  [1.01];
...
%SDIR = '/cscratch/liuy/WorkIR_D/GL/';

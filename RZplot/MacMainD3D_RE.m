...
%Mac.TAUA = 3.2E-007;
%Mac.TAUA = 1.624658853315352E-007;
%Mac.TAUA = 2.0e-07;  %D3D177038
%Mac.TAUA  = 7.284209597809171E-008; %COMPASS
%Mac.TAUA  = 1.069360669420387E-007; %COMPASS18966 
%Mac.TAUA  = 6.5542e-7;  %ITER 10MA
%Mac.TAUA = 4.5846087215013233E-007; %RE_IK
%Mac.TAUA  = 8.2389923123836833E-007; %ITER_15MA_RMP_RE
%Mac.TAUA  = 3.645626154819198E-007; %D3D177040
%Mac.TAUA  = 6.5194e-08;             %D3D184602
%Mac.TAUA  = 2.4138e-07;             %D3D185604
%Mac.TAUA = 2.9375057372504544E-007; %ITER_DINA_68ms NVG=72
%Mac.TAUA = 4.4751e-07; %MAST-U45163
%Mac.TAUA = 7.9397e-07; %MAST-U46943.425
%Mac.TAUA = 3.796032223781379E-007; %KSTAR30306.7850
Mac.TAUA = 1.998572606068899E-007; %D3D177028
...
Mac.RunEF   = 0;  %1: read error field at one surface in vacuum, for generating equivalent surface current
		  ...
		  %4: read vacuum field data at MacSurfS efit grid from PROB_G 
Mac.plot_EF = 1;
...
Mac.RunRE = 1; %plot RE orbit by reading MARS-Q data from RE_TRACE.OUT
Mac.plot_RE_1D = 3;
Mac.plot_RE_2D = 2;
Mac.plot_RE_3D = 4;
...
%SDIR = '/cscratch/liuy/Temp/';
%SDIR = '/cscratch/liuy/WorkDong/0_EFIELD_stuck/0_75/';
%SDIR = '/cscratch/liuy/RE_transport/177040run/';
%SDIR = '/home/liuy/Work/RE_KINK/Data_REK/Common/';
%SDIR = '/home/liuy/Work/RE_ITER/Data_HALO/68ms/';
%SDIR = '/home/liuy/Work/MAST-U/45163/Data/';
%SDIR = '/home/liuy/Work/MAST-U/46943/Data/';
%SDIR = '/home/liuy/Work/KSTAR/Data/30306.7850_gpec/';
%SDIR = '/cscratch/liuy/Du2/';
...
if Mac.RunEQ
   if Mac.plot_EQ, [QEQ] = MacReadPROFEQ([SDIR 'PROFEQ.OUT']); end
   if Mac.plot_BEQ, MacReadBEQ(NCHIM,R,Z,[SDIR 'BEQ_PLS.OUT'],[SDIR 'BEQ_VAC.OUT']); end
end
...
elseif Mac.RunEF==4
   MacGetProbeG([SDIR '../Expt/probe_gb_efitgrid.out'],R,Z,dRds,dZds,dRdchi,dZdchi,jacobian);
end

% perturbed plasma current
if Mac.RunJ
[JM1,JM2,JM3] = MacReadJPLASMA([SDIR 'JPLASMA.OUT'],R,Z);
...
% RE orbit
if Mac.RunRE
MacREORBIT(R,Z,SDIR,'RE_TRACE0001.OUT',2);
end

...
Mac.resetCoil = 1;
%Mac.coilN  = [2.289 0.4805 2.0571 0.8234; 2.0571 0.8234 1.835 0.9988; 2.289 -0.4805 2.0571 -0.8234; 2.0571 -0.8234 1.835 -0.9988];
             % KSTAR passive plates
Mac.coilN   = [2.138 0.942 2.518 0.550; 2.482 0.550 2.482 -0.550; 2.138 -0.942 2.518 -0.550];
             % All KSTAR RMP coils
...
%SDIR = '/cscratch/liuy/WorkKSTAR/EQAC/';
%SDIR = '/cscratch/liuy/WorkIR_D/KU/';
...
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_UL']);

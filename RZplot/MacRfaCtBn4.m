...
%% BPLASMA computed directly in the PEST coordinate system
...
SDIR = '/.automount/funsrv1/root/home/yliu/MAST_ADD/';  facn=pi/2*1.7476; SMAIN='MAST_ALL';
...
if CheckPlot == 0
  eval(['!cp ' SDIR 'RMZM_F_EQAC2 ' SDIR 'RMZM_F']);
  Mac.RunB = 1;
  eval(['MacMain' SMAIN]);
  II = 1:Mac.Ns;
  BnEQAC = Bn(II,:);
  ...
  eval(['!cp ' SDIR 'RMZM_F_PEST3 ' SDIR 'RMZM_F']);
  Mac.RunB = 1;
  eval(['MacMain' SMAIN]);
  II = 1:Mac.Ns;
  BnPEST = Bn(II,:);

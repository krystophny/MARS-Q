...
Mac.coilN   = [5.13 5.92 6.22 3.50; 6.60 2.21 6.60 -2.21; 6.22 -3.50 5.13 -5.92]; 
             % STEP RWM/ELM control coils: old1
%Mac.coilN   = [6.1 6.4 7.92 3.43; 8.27 2.3 8.27 -2.3; 6.1 -6.4 7.92 -3.43];	     
             % STEP RWM/ELM control coils: old2
%Mac.coilN   = [6.35 6.4 8.1 3.42; 8.27 2.3 8.27 -2.3; 6.35 -6.4 8.1 -3.42];	     
             % STEP RWM/ELM control coils: new
%Mac.coilN  = [2.092 0.759 2.278 0.577; 2.278 -0.577 2.092 -0.759];
             % EAST ELM coils: [R1 Z1 R2 Z2;...]
%Mac.rw     = [0.9294];
...
%SDIR = '/cscratch/liuy/STEP-P/Case5_n4/';

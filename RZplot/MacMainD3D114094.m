...
Mac.checkJACOB = 1; % compare jacobian computed from RZ with that computed in CHEASE
Mac.plot_JACOB = 2;
...
% RZ coordinates
[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_fix']);
[R,Z] = MacGetRZ(RM,ZM);
...
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_KINK_Int']);

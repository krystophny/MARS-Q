...
SDIR = '/home/yliu/SEP06/JET/SHOT62653/';
...
% RZ coordinates
[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_JET62653']);
[R,Z] = MacGetRZ(RM,ZM);
if Mac.checkRZ, MacCheckRZ('../TestCirc/RMZM_R'), end

if Mac.RunEQ
[QEQ] = MacReadPROFEQ([SDIR 'PROFEQ_JET62653']);
end
...
if Mac.RunB
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_JET62653_RWM']);

...
Mac.resetCoil = 0;
Mac.coilN  = [11.284 3.9 11.284 -3];     % coils position in (R,Z) coordinates 
Mac.rw     = [1.0 1.10 1.205 1.384]; 
Mac.rs     = Mac.rw; % the position of equivalent sheet current from CARIDDI


Mac.ALPHA   = 1.0;                     
Mac.ShellCurrNorm = 1.0;
SDIR = '/home/yliu/Oct31_2006/Scen4_V8/';
...
[BM1,BM2,BM3] = MacReadBPLASMA('/home/elf/elfliu/FUSION/Machines/ITER/Result/Scen4_V7/BPLASMA_08');

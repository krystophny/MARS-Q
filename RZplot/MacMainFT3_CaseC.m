...
Mac.plot_Bs = 5;     %plot MARS-F-space B1,B2,B3 along chi at wall
...
Mac.coil   = [1.325 -0.125 0.125; 2.0 -0.125 0.125; 1.3 0 0];     % coils position defined as [rc chi_1 chi_2]
Mac.resetCoil = 0;
...
SDIR = '/home/elf/elfliu/FUSION/Machines/FT3/CaseC/';
...
% RZ coordinates
[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_FT3_CaseC']);
[R,Z] = MacGetRZ(RM,ZM);
if Mac.checkRZ, MacCheckRZ('../TestCirc/RMZM_R'), end

if Mac.RunEQ
[QEQ] = MacReadPROFEQ([SDIR 'PROFEQ_FT3_CaseC']);
run /home/elf/elfliu/FUSION/Machines/FT3/CaseC/drawProfEx.m
end
...
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_RFA_wm1e-7']);

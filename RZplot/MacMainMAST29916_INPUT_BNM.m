...
%SDIR = '/home/yliu/F4E_2014/Work/n=2/';
SDIR = '../MAST29916/';
...
% RZ coordinates
[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_SURFS']);
[R,Z] = MacGetRZ(RM,ZM);
...
if Mac.RunEF==1
   %MacGetB1EF([SDIR '29916_surf_ef_n=2.dat'],R,Z,dRdchi,dZdchi);
   MacGetB1EF([SDIR '29916_surf_elm_n=2.dat'],R,Z,dRdchi,dZdchi);
elseif Mac.RunEF==2
...
if Mac.RunJ
[JM1,JM2,JM3] = MacReadJPLASMA([SDIR 'JPLASMA_ELM_U_PLS_24']);
...
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_ELM_U_PLS_07']);

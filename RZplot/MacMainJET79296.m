...
Mac.coilN  = [2.9319    1.6550    2.9311   -2.0300];     
             % MAST EFCC
Mac.rw     =  [2.0335];
Mac.rs     = 1.0382; % the position of equivalent sheet current from CARIDDI
Mac.cut_RZ = -1;
...
SDIR = '/.automount/funsrv1/root/home/yliu/JET_HALO/';
...
if Mac.RunEF>0
   ...
   %Mac.BNORM   = Mac.B0EXP*1e+4*(9.7761e-04+9.7761e-04i);
...
if Mac.RunEF==1
   %MacGetB1EF([SDIR 'decompose_surf_ef_n=1.dat'],R,Z,dRdchi,dZdchi);
   MacGetB1EF([SDIR 'decompose_surf_efcc_n=1.dat'],R,Z,dRdchi,dZdchi);
elseif Mac.RunEF==2

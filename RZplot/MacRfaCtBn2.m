...
global Mac 
global SDIR n_GLOBAL FIN_RES_b1res 
global SDIRW 
...
%SDIR = '/home/yliu/ASDEX_02/Work/';  facn=1.0; SMAIN='AUG_B'; 
%SDIR = '/home/yliu/MAST/MAST25056/';  facn=1.0; SMAIN='AUG_B'; 
%SDIR = '/home/yliu/F4E_2014/DataRes/10100/n=1/';  facn=1.0; SMAIN='ITER_F4E_B'; 
%SDIR = '/home/yliu/KSTAR/Work/';  facn=1.0; SMAIN='KSTAR_B'; 
%SDIR = '/home/yliu/ITER/Scen2_V03/ResDATA_v1.2/n=3B/COMMON/';  facn=1.0; SMAIN='_ITER_B';
%SDIR = '/home/yliu/ITER/Scen2_V03/RmpOptB/n=1/';  facn=1.0; SMAIN='ITER_B';
...
%SDIR = '/home/yliu/EAST_2015/MatlabScripts/';  facn=1.0; SMAIN='EAST_B'; 
%SDIR = '../../YQLiu/FUSION/Machines/MAST_ADD/Matlab/'; facn=1.0; SMAIN='MAST_ALL_B';
%SDIR = '../D3D164362/Work/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '../AUG33133/Work/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/home/liuy/Work/D3D161015/Work/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '../MAST/ResLinResponse/';  
%SDIR = '../MAST/Matlab/'; facn=1.0; SMAIN='MAST_ALL_B';
%SDIR = '/home/yliu/Temp/';  facn=1.0; SMAIN='D3D_ALL_B';   %for AUG-D3D study
%SDIR = '/home/yliu/HL-2A/SHOT29676/Work/';  facn=1.0; SMAIN='D3D_ALL_B'; 
%SDIR = '/home/liuy/Work/JET82469/Work/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/home/liuy/Work/AUG80385/Work/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/home/liuy/Work/MAST25075/Work/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/home/liuy/Work/AUG31128/Work/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/home/liuy/Work/D3D157308/Work/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/home/liuy/IRIS/WorkRWM_TTT/'; facn=1.0; SMAIN='TTT';
%SDIR = '/home/liuy/Work/ITER/Data/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/home/liuy/Work/KSTAR/Data/'; facn=1.0; SMAIN='KSTAR_B';
%SDIR = '/home/liuy/Work/COMPASS/Data/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/home/liuy/Work/D3D166439/Data/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/home/liuy/Work/ITER/Data_EP/10MA/Common/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/home/liuy/Work/AUG34570/Data/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/cscratch/liuy/WorkITER_EPb/'; facn=1.0; SMAIN='D3D_ALL_B';
%SDIR = '/cscratch/liuy/WorkKSTAR/EQAC/'; facn=1.0; SMAIN='KSTAR_B';
%SDIR = '/home/liuy/Work/KSTAR/Data/30306.7850_gpec/'; facn=1.0; SMAIN='KSTAR_B';
SDIR = '/home/liuy/Work/STEP-P/Case5/DataN/'; facn=1.0; SMAIN='KSTAR_B';
%SDIR = SDIRW;  
%SDIR = '/home/liuy/Work/EAST94048/Data/';  facn=1.0; SMAIN='KSTAR_B'; 
%SDIR = '/home/liuy/Work/MAST-U/45272/Data/RMP_n2/';  facn=1.0; SMAIN='KSTAR_B'; 
%SDIR = '//cscratch/liuy/Temp/';  facn=1.0; SMAIN='KSTAR_B'; 
...
%n         = 1;
CheckQ    = 1;
CheckErgos= 3;  %=1: ERGOS definition; =2: SURFMN definition; =3: remove q-factor from b1
PlotBn    = 2;
PlotB1E   = 0;
PlotQ     = 0;
PlotPhi   = 0;
...
%BnPEST = BnPEST*2; %factor of 2 for AUG34570
...
IIM = find(abs(mq-3)<0.1);
BresQ3 = res(1,IIM) + res(2,IIM)*i;
...
%      plot(de(2:end,1).^2,de(2:end,2),'b--','LineWidth',3), hold on,
   ...
   s0 = 0.0;
   JJ = find(s2>=s0);
   pcolor(mk,s2(JJ),abs(BnPEST(JJ,:))*1e+4), hold on, shading interp
   %axis([-10 10 s0 1])
   %save IterCase1Btfte2.mat mk ss BnPEST
   xlabel('m','FontSize',18,'FontWeight','Bold')
   ylabel('\psi_N','FontSize',18,'FontWeight','Bold')
   %ylabel('\psi_N^{1/2}','FontSize',16,'FontWeight','Bold')
...
%   colorbar,  colormap(load('colorbar.txt')')
   ...
   if CheckQ > 0 
      ...
      plot(sq.^2,abs(res(1,:)+res(2,:)*i)*1e+4,'r-o','LineWidth',2,'MarkerSize',9,'MarkerFaceColor','r'), hold on,
      %plot(sq.^2,abs(res(1,:)+res(2,:)*i)*1e+4,'r-o','LineWidth',1,'MarkerSize',9), hold on,
      xlabel('\psi_N','FontSize',16,'FontWeight','Bold')
      ylabel('|b^1_{res}|x10^4','FontSize',16,'FontWeight','Bold')
      ha=get(hf,'CurrentAxes'); set(ha,'FontSize',16,'FontWeight','Bold')

      FIN_RES_b1res = res(1,end)+res(2,end)*i;

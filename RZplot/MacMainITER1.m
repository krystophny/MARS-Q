...
SDIR = '/.automount/funsrv1/root/home/yliu/ITER1/Work/';
...
%facn  = pi/2*1.7476; %n=3
%facn  = 1.6737; %n=6
facn  = 2.1642;  %n=4
I0EXP = 1.0e+3;      %[kA] vacuum shot
mu0   = 4e-7*pi;
fac   = mu0/Mac.R0EXP/facn;
FEEDI = 1.0;
...
if Mac.checkJACOB, MacCheckJacob([SDIR 'JACOBIAN'],jacobian), end
...
%data = load([SDIR 'PROFEQ_PEST']); density = data(:,5);

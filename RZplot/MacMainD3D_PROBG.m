...
Mac.save_FEEDJ = 0;
Mac.read_FEEDJ = 0;
Mac.plot_FEEDJ = 0;Mac.plot_shell = 0;
Mac.plot_shdiv = 0;
Mac.DivJ  = 0;
Mac.plot_DivJ = 0;
...
Mac.RunEF   = 4;  %1: read error field at one surface in vacuum, for generating equivalent surface current
                  %2: read error field at one surface inside plasma, for testing 
		  %3: read probe_g vacuum field data 
Mac.plot_EF = 3;
...
%SDIR = '/.automount/funsrv1/root/home/yliu/MAST_ALL/ResFootPrint/';
%SDIR = '/.automount/funsrv1/root/home/yliu/MAST_ADD/';
%SDIR = '/.automount/funsrv1/root/home/yliu/Temp/';
%SDIR = '/home/liuy/Work/D3D166439/Data/';
SDIR = '/home/liuy/Work/D3D177038/DataM/';
...
% RZ coordinates
[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_EQAC_n6']);
[R,Z] = MacGetRZ(RM,ZM);
...
if Mac.RunEF==1
   ...
   %MacGetB1EF([SDIR '26128_surf_ef_n=1.dat'],R,Z,dRdchi,dZdchi);
    %MacGetB1EF([SDIR 'b_ef_ccoil.dat'],R,Z,dRdchi,dZdchi);
   %MacGetB1EF([SDIR 'b_ef_icoil.dat'],R,Z,dRdchi,dZdchi);
   %MacGetB1EF([SDIR 'b_ccoil.dat'],R,Z,dRdchi,dZdchi);
    %MacGetB1EF([SDIR 'b_ef.dat'],R,Z,dRdchi,dZdchi);
...
elseif Mac.RunEF==3
   %MacGetB1EF([SDIR '../Expt/166439.03300.mars.probe_gb.out'],R,Z,dRdchi,dZdchi);
   MacGetB1EF([SDIR '../Expt/probe_gb_surface_new.out'],R,Z,dRdchi,dZdchi);
elseif Mac.RunEF==4
   MacGetProbeG([SDIR '../Expt/probe_gb_efitgrid_new.out'],R,Z,dRds,dZds,dRdchi,dZdchi,jacobian);
end

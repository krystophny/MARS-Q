...
Mac.BNORM = 1.0;
Mac.JNORM = 1.0;
Mac.PNORM = -1.0*exp(-0.39426i);
Mac.VNORM = 1.0;

%SDIR = '/.automount/funsrv1/root/home/yliu/Solov/ResKinetic1.6_0.33_1.9/';
SDIR = '/.automount/funsrv1/root/home/yliu/SolovNew/Solov3/';
...
% perturbed velocity
if Mac.RunV
[VM1,VM2,VM3,DPSIDS,T] = MacReadVPLASMA([SDIR 'VPLASMA_PEST']);

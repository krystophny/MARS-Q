...
Mac.BNORM = 1.0;
Mac.JNORM = 1.0;
p = 0.0;  %knk:0.3070; rwm:0.0158; sck:-0.19626;
Mac.VNORM = 1.0*exp(i*pi*p);
Mac.PNORM = 1.0*exp(i*pi*p); 

%SDIR = '/.automount/funsrv1/root/home/yliu/ITER/Scen4_V14/DataMar/M2_20/';
...
if Mac.RunJ
[JM1,JM2,JM3] = MacReadJPLASMA([SDIR 'JPLASMA_Swall']);
...
% perturbed velocity
if Mac.RunV
[VM1,VM2,VM3,DPSIDS,T] = MacReadVPLASMA([SDIR 'VPLASMAsck']);
...
% perturbed pressures
if Mac.RunP
[PM1,PM2,PM3] = MacReadPPLASMA([SDIR 'PPLASMAsck']);

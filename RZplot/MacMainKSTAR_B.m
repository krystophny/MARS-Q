...
%Mac.BNORM   = Mac.B0EXP*1e+4; %[G]
Mac.VNORM   = Mac.R0EXP*1e+3; %[mm]
if Mac.RunEF>0
...
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR SDIR5 'BPLASMA.OUT']);
...
% perturbed velocity
if Mac.RunV
[VM1,VM2,VM3,DPSIDS,T] = MacReadVPLASMA([SDIR SDIR5 'XPLASMA_EQAC']);

...
Mac.plot_BWP = 3;    %plot real-space Bwn,Bwt,Bwphi along physical theta 
...
SDIR = '/home/elf/elfliu/FUSION/Collaborations/Villone/TestCirc/Res03/';
...
% RZ coordinates
[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_RWM']);
%[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_Stime']);
[R,Z] = MacGetRZ(RM,ZM);
...
if Mac.RunJ
[JM1,JM2,JM3] = MacReadJPLASMA([SDIR 'JPLASMA_WALL2']);
...
[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_WALL2']);
%[BM1,BM2,BM3] = MacReadBPLASMA([SDIR 'BPLASMA_Srfa2']);

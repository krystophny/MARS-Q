...
Mac.spline_B23 = 2;
Mac.plot_B  = 0;
Mac.plot_BR = 0;     %plot Br,Bz along lines across plasma, Mac.RZmap must be 1
...
Mac.resetCoil = 0;
Mac.coilN  = [2.184 1.012 2.394 0.504; 2.184 -1.012 2.394 -0.504; 2.413 0 2.413 0];     % I/S-coil: [R1 Z1 R2 Z2;...]
Mac.rw     = [1.15108];
Mac.rs     = 1.15108; % the position of equivalent sheet current from CARIDDI
...
SDIR = '/.automount/funsrv1/root/home/yliu/D3D1357XX/';
...
% RZ coordinates
[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_D3D135773']);
[R,Z] = MacGetRZ(RM,ZM);
...
I0EXP = 1.0e+3*pi/3;      %[kA] vacuum shot
mu0   = 4e-7*pi;
fac   = mu0/Mac.R0EXP;
FEEDI = 1.0;

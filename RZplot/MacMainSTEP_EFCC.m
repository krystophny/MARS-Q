...
Mac.R0EXP  = 2.5;    % active if Mac.Norm=0 
Mac.B0EXP  = 2.416;    % active if Mac.Norm=0 
...
if Mac.RunEF==1
   ...
   %MacGetB1EF([SDIR 'b_ccoil.dat'],R,Z,dRdchi,dZdchi);
    %MacGetB1EF([SDIR 'b_ef.dat'],R,Z,dRdchi,dZdchi);
     MacGetB1EF([SDIR 'b_ccoil_BOT.dat'],R,Z,dRdchi,dZdchi);
elseif Mac.RunEF==2
   ...
   MacGetB1EF([SDIR 'decompose_surf_q=3.dat'],R,Z,dRdchi,dZdchi);
end

...
Mac.resetCoil = 0;
Mac.coilN  = [3.23 0.8 3.23 -0.8; 2.477 0.597 2.447 -0.597];     % I-coil: [R1 Z1 R2 Z2;...]
Mac.rw     = [1.0 1.186 4.0];
...
SDIR = '/home/yliu/SEP06/DIII-D/SHOT118620/';
...
% RZ coordinates
[RM,ZM] = MacReadRMZM([SDIR 'RMZM_F_D3D118620']);
[R,Z] = MacGetRZ(RM,ZM);
